...
class Tkinter_Lihi:
    ...
    def first_menu(self):
        ...
        tk.Button(self.window, text='Load from zip', command=self.combine_funcs(self.data_handler.extract_data, self.second_menu), background='#42eff5').pack(anchor='nw', padx=40, pady=50)
